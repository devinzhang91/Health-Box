...
public class PullToFlashAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            switch (type) {
                case TYPE_1:
                    convertView = inflater.inflate(R.layout.terminal_view,
                            parent, false);
                    holder1 = new ViewHolder1();
                    holder1.tv_chartSting = (TextView) convertView
                            .findViewById(R.id.textView_chart_string);
                    holder1.et_chartSting = (EditText) convertView
                            .findViewById(R.id.editText_chart_string);
                    holder1.btn_send = (Button) convertView
                            .findViewById(R.id.button_send);
                    holder1.sv = (ScrollView) convertView
                            .findViewById(R.id.scrollView);
                    convertView.setTag(holder1);

                    AbsListView.LayoutParams lp = new AbsListView.LayoutParams( LinearLayout.LayoutParams.MATCH_PARENT, 1200);
        ...
        switch (type) {
            case TYPE_1:
                holder1.tv_chartSting.setText(strChart);
                final ViewHolder1 finalHolder = holder1;
                holder1.btn_send.setOnClickListener(new Button.OnClickListener(){//创建监听
                    public void onClick(View v) {
                        String strSend = finalHolder.et_chartSting.getText().toString();
                        //send
                        strChart += strSend;
                        finalHolder.tv_chartSting.setText(strChart);
                        finalHolder.sv.fullScroll(ScrollView.FOCUS_DOWN);
                    }
                });
                break;
            case TYPE_2:
    ...
    public class ViewHolder1 {
        TextView tv_chartSting;
        EditText et_chartSting;
        Button btn_send;
        ScrollView sv;
    }
